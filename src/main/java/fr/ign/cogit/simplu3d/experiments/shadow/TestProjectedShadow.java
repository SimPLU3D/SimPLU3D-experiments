...
public class TestProjectedShadow {
	...
	public static void main(String[] args) throws Exception {
		...
		// SimPLU3D project
		String folder = TestProjectedShadow.class.getClassLoader().getResource("data/projectShadow/").getPath();
		...
		// This part is only used to texture the ground to make a prette scene <3
		...
		// --SimPLU3D Buildings
		// --Parcels : shadow is projected on parcels
		// --If parcel is empty or there is not intersection, shadow is projected on
		// scene footprint
